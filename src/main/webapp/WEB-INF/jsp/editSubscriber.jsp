...
<title><sping:message code="editSubscriber.title"/></title>
		...
		<div class="container-fluid ">
			<div class="row">
				...
				<div class="col-xs-10 col-xs-offset-2 col-sm-10 col-sm-offset-2 col-md-10 col-md-offset-2 main">
					<h2 class="page-header"><sping:message code="editSubscriber.title"/></h2>
					<div class="col-sm-8">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<div class="col-sm-offset-5 col-sm-8">
											<button type="submit" formaction="editSubscriber.do" class="btn btn-primary">Сохранить</button>

											<button type="submit" formaction="subscriberSearchEdit.do" class="btn btn-primary">Отмена</button>
										</div>
									</div>
								</div>
							</div>

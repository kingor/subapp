							...
							<thead>
								<tr>
									...
									<i class="glyphicon glyphicon-sort-by-attributes-alt"></i>	</a> 
										<sping:message code="phone.number"/> <a href="phones.do?sort=number&order=asc">
									<i class="glyphicon glyphicon-sort-by-attributes"></i>
									</a></th>
									<th class="col-sm-2 col-md-2"><a href="phones.do?sort=band&order=desc">
									<i class="glyphicon glyphicon-sort-by-attributes-alt"></i></a>
										<sping:message code="phone.band"/> <a href="phones.do?sort=band&order=asc">
									<i class="glyphicon glyphicon-sort-by-attributes"></i></a>
									</th>
									<th class="col-sm-2 col-md-2"><a href="phones.do?sort=security&order=desc">
									<i class="glyphicon glyphicon-sort-by-attributes-alt"></i></a>
										<sping:message code="phone.security"/> <a href="phones.do?sort=security&order=asc">
									<i class="glyphicon glyphicon-sort-by-attributes"></i></a>
									</th>
									<th class="col-sm-1 col-md-1"><a href="phones.do?sort=scv&order=desc">
									<i class="glyphicon glyphicon-sort-by-attributes-alt"></i></a>
										<sping:message code="phone.scv"/> <a href="phones.do?sort=scv&order=asc">
									<i class="glyphicon glyphicon-sort-by-attributes"></i></a>
									</th>
									<th class="col-sm-1 col-md-1"><a href="phones.do?sort=adsl&order=desc">
									<i class="glyphicon glyphicon-sort-by-attributes-alt"></i></a>
										<sping:message code="phone.adsl"/> <a href="phones.do?sort=adsl&order=asc">
									<i class="glyphicon glyphicon-sort-by-attributes"></i></a>
									</th>
									<th class="col-sm-4 col-md-4"><a href="phones.do?sort=name&order=desc">
									<i class="glyphicon glyphicon-sort-by-attributes-alt"></i></a>
										<sping:message code="subscriber.name"/> <a href="phones.do?sort=name&order=asc">
									<i class="glyphicon glyphicon-sort-by-attributes"></i></a>
									</th>
								</tr>
							</thead>

...
<form name="form3" method="get" action="subscriberSearchEdit.do">
							<thead>
								<tr>
									...
									</a> ФИО абонента <a href="subscriberSearchEdit.do?sort=name&order=asc&name=${name}&address=${address}&comment=${comment}"> <i class="glyphicon glyphicon-sort-by-attributes"></i>
									</a></th>
									<th class="col-sm-4 col-md-4"><a href="subscriberSearchEdit.do?sort=address&order=desc&name=${name}&address=${address}&comment=${comment}"> <i
											class="glyphicon glyphicon-sort-by-attributes-alt"></i></a> Адрес абонента <a href="subscriberSearchEdit.do?sort=address&order=asc&name=${name}&address=${address}&comment=${comment}"> <i
									...
									<th class="col-sm-3 col-md-3"><a href="subscriberSearchEdit.do?sort=comment&order=desc&name=${name}&address=${address}&comment=${comment}"> <i
											class="glyphicon glyphicon-sort-by-attributes-alt"></i></a> Примечание <a href="subscriberSearchEdit.do?sort=comment&order=asc&name=${name}&address=${address}&comment=${comment}"> <i
											class="glyphicon glyphicon-sort-by-attributes"></i></a></th>

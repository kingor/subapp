...
<title><sping:message code="viewSubscribers.title"/></title>
		...
		<div class="container-fluid ">
			<div class="row">
				...
				<div
					...
					<h2 class="page-header"><sping:message code="viewSubscribers.title"/></h2>
						...
						<table class="table table-condensed table-striped">
							<thead>
								<tr>
									...
									</a> <sping:message code="subscriber.name"/> <a href="subscribers.do?sort=name&order=asc">
											<i class="glyphicon glyphicon-sort-by-attributes"></i>
									</a></th>
									<th><a href="subscribers.do?sort=address&order=desc">
									<i class="glyphicon glyphicon-sort-by-attributes-alt"></i></a>
										<sping:message code="subscriber.address"/> <a href="subscribers.do?sort=address&order=asc">
									<i class="glyphicon glyphicon-sort-by-attributes"></i></a>
									</th>
									<th><a href="subscribers.do?sort=comment&order=desc">
									<i class="glyphicon glyphicon-sort-by-attributes-alt"></i></a>
										<sping:message code="subscriber.comment"/> <a href="subscribers.do?sort=comment&order=asc">
									<i class="glyphicon glyphicon-sort-by-attributes"></i></a>
									</th>
									<th><sping:message code="subscriber.full"/></th>
								</tr>
							</thead>
							<tbody>

...
<c:url var="addUrl" value="/mycompany/main/actors/add" />
<table style="border: 1px solid; width: 500px; text-align:center">
 ...
 <c:url var="editUrl" value="/mycompany/main/actors/edit?id=${actor.id}" />
   <c:url var="deleteUrl" value="/mycompany/main/actors/delete?id=${actor.id}" /> 
  <tr>

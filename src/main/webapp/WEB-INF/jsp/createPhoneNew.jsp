						...
						<table class="table table-condensed table-bordered">
							...
							<thead>
								<tr>
									...
									</a> ФИО абонента <a href="createPhoneNew?sort=name&order=asc&name=${name}&address=${address}&comment=${comment}"> <i class="glyphicon glyphicon-sort-by-attributes"></i>
									</a></th>
									<th class="col-sm-4 col-md-4"><a href="createPhoneNew?sort=address&order=desc&name=${name}&address=${address}&comment=${comment}"> <i
											class="glyphicon glyphicon-sort-by-attributes-alt"></i></a> Адрес абонента <a href="createPhoneNew?sort=address&order=asc&name=${name}&address=${address}&comment=${comment}"> <i
									...
									<th class="col-sm-3 col-md-3"><a href="createPhoneNew?sort=comment&order=desc&name=${name}&address=${address}&comment=${comment}"> <i
											class="glyphicon glyphicon-sort-by-attributes-alt"></i></a> Примечание <a href="createPhoneNew?sort=comment&order=asc&name=${name}&address=${address}&comment=${comment}"> <i
											class="glyphicon glyphicon-sort-by-attributes"></i></a></th>
